...
<html lang="hr">
    <head>
        ...
        <meta
            name="description"
            content="30.3.2021. Stranica O autoru web stranice, ključne riječi: autor, sport, novosti"
        />
    ...
    <body>
        ...
        <main id="content">
            <section aria-label="about author" class="box centered">
                ...
                <figure>
                    <picture>
                        ...
                        <img
                            src="./multimedija/images/profilna.jpeg"
                            alt="Toni Škobić"
                        />
                    </picture>
                ...
                <blockquote
                    cite="https://www.fearlessmotivation.com/2017/03/11/15-powerful-lionel-messi-quotes/"
                >
                    <p>
            ...
            <iframe
                ...
                src="https://www.youtube.com/embed/PSanJ5swYBM?autoplay=1"
        ...
        <footer class="box-fluid footer m-t-md">
            ...
            <section aria-label="validation references">
                <a
                    href="http://validator.w3.org/check?uri=http://barka.foi.hr/WebDiP/2020/zadaca_03/tskobic/autor.html"
                    class="m-l-sm"
                >
