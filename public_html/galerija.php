...
<html lang="hr">
    <head>
        ...
        <meta
            name="description"
            content="30.3.2021. Stranica galerija, ključne riječi: galerija, sport, novosti"
        />
    ...
    <body>
        ...
        <main id="content">
            <button
                name="load"
                class="button button--primary m-t-md m-b-md centered load"
            >
                Učitaj slike
            </button>
            ...
            <section class="gallery" aria-label="gallery">
                <div class="gallery__image default hidden">
                    <figure class="zoom">
                        <picture>
                            ...
                            <img
                                src="./multimedija/images/default.jpg"
                                alt="Default"
                            />
                        </picture>
                ...
                <div class="gallery__image">
                    <figure class="zoom">
                        <picture>
                            <source
                                srcset="./multimedija/images/barcelona.png"
                            />
                            <img
                                src="./multimedija/images/barcelona.png"
                                alt="Barcelona"
                            />
                        </picture>
                ...
                <div class="gallery__image">
                    <figure class="zoom">
                        <picture>
                            ...
                            <img
                                src="./multimedija/images/benzema.jpg"
                                alt="Benzema"
                            />
                        </picture>
                ...
                <div class="gallery__image">
                    <figure class="zoom">
                        <picture>
                            <source
                                srcset="./multimedija/images/granadaplayers.jpg"
                            />
                            <img
                                src="./multimedija/images/granadaplayers.jpg"
                                alt="Igrači Granade"
                            />
                        </picture>
                ...
                <div class="gallery__image">
                    <figure class="zoom">
                        <picture>
                            <source
                                srcset="./multimedija/images/griezmann.jpg"
                            />
                            <img
                                src="./multimedija/images/griezmann.jpg"
                ...
                <div class="gallery__image">
                    <figure class="zoom">
                        <picture>
                            <source
                                srcset="./multimedija/images/joaofelix.jpg"
                            />
                            <img
                                src="./multimedija/images/joaofelix.jpg"
                                alt="Joao Felix"
                            />
                        </picture>
                ...
                <div class="gallery__image">
                    <figure class="zoom">
                        <picture>
                            ...
                            <img
                                src="./multimedija/images/koke.jpg"
                                alt="Koke"
                            />
                        </picture>
                ...
                <div class="gallery__image">
                    <figure class="zoom">
                        <picture>
                            ...
                            <img
                                src="./multimedija/images/laliga.png"
                                alt="LaLiga"
                            />
                        </picture>
                ...
                <div class="gallery__image">
                    <figure class="zoom">
                        <picture>
                            <source
                                srcset="./multimedija/images/laligaball.jpg"
                            />
                            <img
                                src="./multimedija/images/laligaball.jpg"
                                alt="LaLiga lopta"
                            />
                        </picture>
                ...
                <div class="gallery__image">
                    <figure class="zoom">
                        <picture>
                            ...
                            <img
                                src="./multimedija/images/messi.jpeg"
                                alt="Lionel Messi"
                            />
                        </picture>
                ...
                <div class="gallery__image">
                    <figure class="zoom">
                        <picture>
                            ...
                            <img
                                src="./multimedija/images/modrić.jpeg"
                                alt="Luka Modrić"
                            />
                        </picture>
                ...
                <div class="gallery__image">
                    <figure class="zoom">
                        <picture>
                            ...
                            <img
                                src="./multimedija/images/ramos.jpg"
                                alt="Sergio Ramos"
                            />
                        </picture>
                ...
                <div class="gallery__image">
                    <figure class="zoom">
                        <picture>
                            ...
                            <img
                                src="./multimedija/images/suarez.jpg"
                                alt="Luis Suarez"
                            />
                        </picture>
        ...
        <footer class="box-fluid footer m-t-md">
            ...
            <section aria-label="validation references">
                <a
                    href="http://validator.w3.org/check?uri=http://barka.foi.hr/WebDiP/2020/zadaca_03/tskobic/galerija.html"
                    class="m-l-sm"
                >
