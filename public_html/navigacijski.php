...
<html lang="hr">
    <head>
        ...
        <meta
            name="description"
            content="10.4.2021. Navigacijski dijagram stranica web stranice, ključne riječi: navigacijski, sport, novosti"
        />
    ...
    <body>
                ...
                <a href="./multimedija/images/tskobic-navigacijski1.png">
                    <figure class="figure-width">
                        <picture class="diagrams">
                            ...
                            />
                            <img
                                src="./multimedija/images/tskobic-navigacijski1.png"
                                alt="Navigacijski dijagram za neregistriranog korisnika"
                                width="200"
                                height="200"
                            />
                        </picture>
                ...
                <a href="./multimedija/images/tskobic-navigacijski2.png">
                    <figure class="figure-width">
                        <picture class="diagrams">
                            ...
                            />
                            <img
                                src="./multimedija/images/tskobic-navigacijski2.png"
                                alt="Navigacijski dijagram za registriranog korisnika"
                                width="200"
                                height="200"
                            />
                        </picture>
                ...
                <a href="./multimedija/images/tskobic-navigacijski3.png">
                    <figure class="figure-width">
                        <picture class="diagrams">
                            ...
                            />
                            <img
                                src="./multimedija/images/tskobic-navigacijski3.png"
                                alt="Navigacijski dijagram za moderatora"
                                width="200"
                                height="200"
                            />
                        </picture>
                ...
                <a href="./multimedija/images/tskobic-navigacijski4.png">
                    <figure class="figure-width">
                        <picture class="diagrams">
                            ...
                            />
                            <img
                                src="./multimedija/images/tskobic-navigacijski4.png"
                                alt="Navigacijski dijagram za administratora"
                                width="200"
                                height="200"
                            />
                        </picture>
        ...
        <footer class="box-fluid footer m-t-md">
            ...
            <section aria-label="validators">
                <a
                    href="http://validator.w3.org/check?uri=http://barka.foi.hr/WebDiP/2020/zadaca_03/tskobic/"
                    class="m-l-sm"
                >
